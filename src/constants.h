...
#define STATE_KEY_TRANSITION_TO_PRESSED                (0)
#define STATE_KEY_PRESSED                              (1)
#define STATE_KEY_TRANSITION_TO_RELEASED               (2)
...
{ 
	...
	DEV_RECEIVE_OPER, DEV_TRANSMIT_OPER, DEV_READ_OPER, DEV_WRITE_OPER, DEV_OPEN_OPER, DEV_CLOSE_OPER 
} dev_oper_t;
